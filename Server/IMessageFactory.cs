...
namespace Server
{
    ...
    public interface IMessageFactory
    {
        ...
        /// <param name="senderEndPoint">Сетевая конечная точка отправителя сообщения.</param>
        /// <returns>Экземпляр сообщения, сконфигурированный согласно предоставленным параметрам.</returns>
        Message CreateMessage(string content, string from, string to, IPEndPoint senderEndPoint);
    }
}
